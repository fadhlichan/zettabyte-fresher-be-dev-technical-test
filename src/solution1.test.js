const result = require('./solution1')
...
test('Should return correct formatted sessions array', () => {
    expect(result(rawSessions)).toEqual(formatedSessions)
})